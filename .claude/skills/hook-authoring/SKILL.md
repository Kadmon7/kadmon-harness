...
The full 22-hook catalog, exit-code table, performance budgets, and shared-modules table remain in `.claude/rules/common/hooks.md` (auto-loaded). This skill covers only the deep runtime/platform mechanics.
