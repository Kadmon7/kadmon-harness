---
name: context-budget
description: Manage Claude Code's context window to avoid performance degradation. Use this skill when responses feel slower or less accurate, when planning a long multi-file session, or when switching between major tasks. Also use when the user mentions "context", "window", "slow", "compact", or "running out of space". Helps decide WHEN to compact and what to keep in context.
---
