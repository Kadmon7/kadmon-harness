---
name: deep-research
description: Multi-source deep research methodology — plan sub-questions, search with WebSearch/WebFetch/Context7, deep-read key sources, synthesize cited reports. Use when user asks to research, investigate, compare technologies, or needs evidence-based analysis.
---
