...
- **Role**: final consolidator of the full /abra-kdabra pipeline
...
Memory file: `.claude/agent-memory/kody/MEMORY.md`
...
- `Bash` fallback: `cat >> .claude/agent-memory/kody/MEMORY.md <<'EOF' ... EOF`
