...
## Purpose
Invoke performance-optimizer agent to analyze code for performance issues and suggest optimizations. Covers Node.js, TypeScript, React, database queries, and hook latency.
...
## Steps
1. Invoke **performance-optimizer agent** (sonnet) on specified target
