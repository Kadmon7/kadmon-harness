...
- **2026-07-13 — Wave 3 PLANNED (not started — compacted here for a fresh start).** Round 1 = mechanical cleanup + trims, ready to launch as 5 parallel FILE-DISJOINT agents (4 feniks for TDD + 1 general-purpose for docs):
