...
- **Tests:** 637 → 1522. Files: 60 → 111. Hooks: 21 → 23 (22 plugin-shipped script hooks + 1 inline graphify nudge) + 12 shared modules. /medik checks: 8 → 16. Skills: 46 → 53. Commands: 11 → 12.
