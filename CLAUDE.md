...
## Status
v1.4.0 — 1490 tests / 111 files / 23 hooks / 16 agents / 53 skills / 12 commands / 19 rules / 7 DB tables / 16 /medik checks. Web dashboard at `npm run dashboard:web` (plan-039, Kadmon Brand v0.2).
